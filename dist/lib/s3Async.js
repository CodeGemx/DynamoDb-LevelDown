...
class S3Async {
    constructor(s3, bucketName) {
        ...
        if (!!s3) {
            this.putObjectAsync = util_1.promisify(this.s3.putObject).bind(this.s3);
            this.getObjectAsync = util_1.promisify(this.s3.getObject).bind(this.s3);
            this.headBucketAsync = util_1.promisify(this.s3.headBucket).bind(this.s3);
            this.createBucketAsync = util_1.promisify(this.s3.createBucket).bind(this.s3);
            this.deleteObjectAsync = util_1.promisify(this.s3.deleteObject).bind(this.s3);
            this.deleteBucketAsync = util_1.promisify(this.s3.deleteBucket).bind(this.s3);
        }
    }
    bucketExists() {
