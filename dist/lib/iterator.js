...
exports.DynamoDbIterator = void 0;
...
class DynamoDbIterator extends abstract_leveldown_1.AbstractIterator {
    ...
    _next(cb) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!streamObject) {
                ...
                key = this.keyAsBuffer ? utils_1.castToBuffer(key) : key;
                value = this.valueAsBuffer ? utils_1.castToBuffer(value) : value;
    ...
    _seek(target) {
        this.isOutOfRange = false;
        this.seekTarget = !!target && utils_1.isBuffer(target) ? target.toString() : target;
    }
    peekNextKey() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    createReadStream(opts) {
        ...
        const getValue = (item) => {
            if (!opts.keys) {
                return utils_1.withoutKeys(item);
            }
            if (keysOnly) {
                return utils_1.withKeysOnly(item);
            }
            return item;
        };
        const isFinished = () => {
        ...
        const stream = through2_1.default.obj(function (data, enc, cb) {
            return __awaiter(this, void 0, void 0, function* () {
                returnCount += 1;
                pushNext(this, { key: utils_1.rangeKeyFrom(data), value: getValue(data.value) });
                if (isFinished()) {
                    this.emit(EVENT_END);
                }
                cb();
        ...
        const onData = (err, data) => {
            ...
            data.Items.forEach((item) => {
                const rangeKey = utils_1.rangeKeyFrom(item);
    ...
    getDataRange(options, cb) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rangeCondition = utils_1.createRangeKeyCondition(opts);
            const params = {
                KeyConditions: utils_1.keyConditionsFor(this.hashKey, rangeCondition),
            ...
            try {
                ...
                (_a = records.Items) === null || _a === void 0 ? void 0 : _a.forEach((item) => (item.value = utils_1.dataFromItem(item)));
...
exports.DynamoDbIterator = DynamoDbIterator;
